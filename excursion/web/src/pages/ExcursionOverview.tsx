      ...
      <div>
        <Carousel>
          <Carousel.Item interval={10000} onClick={() => updateExcursionID(0)}>
            <img className="d-block w-100" src={whale} alt="First slide" />
            <Carousel.Caption>
              <h3>{data[0].Name}</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item interval={10000} onClick={() => updateExcursionID(1)}>
            <img className="d-block w-100" src={dogsled} alt="Second slide" />
            <Carousel.Caption>
              <h3>{data[1].Name}</h3>
            </Carousel.Caption>
          </Carousel.Item>
          <Carousel.Item interval={10000} onClick={() => updateExcursionID(2)}>
            <img className="d-block w-100" src={rib} alt="Third slide" />
            <Carousel.Caption>
              <h3>{data[2].Name}</h3>
            </Carousel.Caption>
          </Carousel.Item>
